...
for fold in range(n_folds):
    ...
    start_it = time.time()
    print 'python2  main.py --fold '+ str(fold) + ' --epoch ' + str(epochs) + '--dataset ' + 'fold_'+(fold)
    os.system('python2  main.py --fold '+ str(fold) + ' --epoch ' + str(epochs) + '--dataset ' + 'data/fold_'+(fold))
